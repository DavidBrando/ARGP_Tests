#undef MECHANICSTEST_API
#undef MECHANICSTEST_VTABLE
...
#define UE_PROJECT_NAME MechanicsTest
...
#define MECHANICSTEST_VTABLE DLLEXPORT_VTABLE
#define MECHANICSTEST_API DLLEXPORT
